...
<form id="form_usuario" method="post">
    <div class="btn-toolbar">
        <a href="<?php echo base_url() ?>admin/NovoLogradouro/Inserir"<button type ="submit" class="btn btn-primary" id ="enviar"><i class="fa fa-plus-square fa-fw"></i> Logradouro </button></a> 
    </div>
    <br/>
    <div class="well">
        <div class="table-responsive">
            <table id="tabelaLogradouros" class="table table-striped" class="display" cellspacing="0" width="100%">
                <thead>       
                    <tr>
                        <th>ID</th>
                        <th>Descrição</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#tabelaLogradouros').DataTable({
            "processing": true,
            "ajax": "logradouro/getLogradouros/",
            "order": [[1, "asc"]],
            deferRender: true,
            "fnRowCallback": function (nRow, aData) {
                $(this).on("click", "#deletaLogradouro" + aData[0], function () {
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    "aTargets": [3],
                    "mRender": function (data, type, full) {
                        return '<button class="btn btn-danger" id="deletaLogradouro' + full[0] + '" type="submit" name="deletar" value= "' + full[0] + '">Deletar <i class="fa fa-trash-o"></i></button>';
                    }
                }
            ]
        });
