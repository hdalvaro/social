<div id="container">
    <div class="tab-pane active in" id="home">        
        <form id="formProblema" name="novobairro" method ="post">
            <?php
            if (isset($bairro)) { //Se for Atualização carrega os valores
            ...
            ?>        
            <h3 class="">Cadastro de Bairros</h3>
            <div class="row form-group">                        
                ...
                <div class="col-md-12 col-xs-12 col-lg-8 col-sm-12"> 
                    <label for="descricao">Nome do Bairro</label>
