<div id="container">
    <div class="tab-pane active in" id="home">        
        <form id="formInstituicao" name="novainstituicao" method ="post">
            <?php
            if (isset($instituicao)) { //Se for Atualização carrega os valores
            ...
            ?>        
            <h3 class="">Cadastro de Instituições</h3>
            <div class="row form-group">                        
                ...
                <div class="col-md-12 col-xs-12 col-lg-8 col-sm-12"> 
                    <label for="descricao">Instituição</label>
